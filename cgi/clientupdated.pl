...
<td>
<input name="A_name" type="text" size="30" maxlength="30" value="$row[13]">
</td>
</tr>
...
<td>
<input name="A_consultant" type="text" size="25" maxlength="25" value="$row[14]">
</td>
</tr>
...
<td>
<input name="A_telno" type="text" size="25" maxlength="25" value="$row[15]">
</td>
</tr>
...
<td>
<input name="A_faxno" type="text" size="25" maxlength="25" value="$row[16]">
</td>
...
<tr>
<td>
<img src="/buttons/emailaddress.png">
</td>
<td>
<input name="A_email" type="text" size="25" maxlength="25">
</td>
...
<td>
<textarea name="A_instructions" cols="70" rows="5">$row[17]</textarea>
</td>
