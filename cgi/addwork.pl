...
$out =$dbh->do("insert into client_table (CD_date, CR_date, C_name, C_telno, CD_pickuptime, CR_pickuptime, CD_flightno, CR_flightno, CD_addressfrom, CR_addressfrom, CD_addressto, CR_addressto, A_name, A_consultant, A_telno, A_faxno, A_instructions, C_invoice, C_payment)
                values ('$CD_date', '$CR_date', '$C_name', '$C_telno', '$CD_pickuptime', '$CR_pickuptime', '$CD_flightno', '$CR_flightno', '$CD_addressfrom', '$CR_addressfrom', '$CD_addressto', '$CR_addressto', '$A_name', '$A_consultant', '$A_telno', '$A_faxno', '$A_instructions', '$invoice', '$C_payment')")
